package com.example.purplebox.adapters.recyclerview
...
import com.example.purplebox.databinding.ColorAndSizesBinding
        ...
        if (type == COLORS_TYPE) {
            ...
            if(selectedPosition == position){
                holder.binding.apply {
                    ...
                    imgContent.setImageResource(R.color.icon_tint)
                    imgShadow.setImageResource(R.color.circle_shadow)
                ...
                holder.binding.apply {
                    ...
                    imgContent.setImageResource(R.color.icon_tint)
                    imgShadow.setImageResource(R.color.icon_tint)
                    tvSize.visibility = View.VISIBLE
                    tvSize.text = size
                }
            }
